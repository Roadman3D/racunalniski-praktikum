...
$$ M2(n; A,D) = \frac{1}{2} n \left(2A + D(n^2 - 1)\right) $$
Kvadratu v tabeli \ref{table:closhu} ustrezata konstanti $A=20$ in $D=1$.
...
Na primer, magičnemu kvadratu Lo Shu (glej tabelo \ref{table:closhu}) priredimo
komplementarni kvadrat, prikazan v tabeli \ref{table:sagrada}.
...
180 stopinj okrog središča, kvadrat iz tabele \ref{table:durer} pa je mogoče dobiti
...
\begin{table}
   ...
   \begin{tabular}{lcccccc}\toprule
      & \multicolumn{5}{c}{točna vrednost} točna vrednost & približek \\\midrule
